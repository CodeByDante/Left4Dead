...
| bugreporter_console_bytes                        | 15000       | "launcher"              | Máximo número de bytes de consola para incluir en el cuerpo del informe de errores (el texto completo aún está adjunto). |
